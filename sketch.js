...
function setup() 
{
  ...
  stardisply = createSprite(50,20,30,30);
  stardisply.addAnimation("empty",emptyStar);
  stardisply.addAnimation("one",oneStar);
  stardisply.addAnimation("two",twoStar);
  stardisply.changeAnimation("empty")
  stardisply.scale=0.2;
...
function draw() 
{
 ...
 if (collide(fruit,star,20)==true){
   star.visible=false;
 stardisply.changeAnimation("one")
 }
 if (collide(fruit,star2,20)==true){
   star2.visible=false;
   stardisply.changeAnimation("two")
 }
}
